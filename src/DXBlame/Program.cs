...
namespace DXBlame
{
    class Program
    {
        ...
        {
            BlameWindowModel model = new BlameWindowModel(file, fileSource, lineNumber, direct);
            IBlameWindowView ui = new DXVcsTools.UI.WinForms.ViewFactory().CreateBlameWindow();
        ...
        static void PrintUsage()
        {
            ...
            Console.WriteLine(
                ...
                "    {0} vsblame <file> <projectFile> <lineNumber>",
                programName);
        }
    }
}
