...
namespace Microsoft.VsSDK.IntegrationTestLibrary {
    ...
    class DialogBoxPurger : IDisposable {
        ...
        /// </summary>
        readonly int numberOfDialogsToWaitFor = 1;

        /// <summary>
        ///     Calling thread signales to this thread to die.
        /// </summary>
        readonly AutoResetEvent threadDone = new AutoResetEvent(false);

        /// <summary>
        ///     The queued thread started.
        /// </summary>
        readonly AutoResetEvent threadStarted = new AutoResetEvent(false);
                        ...
                        if (windowClassName.ToString().Contains("#32770")) {
                            ...
                            lock (Mutex) {
                                ...
                                if (String.IsNullOrEmpty(expectedDialogBoxText) ||
                                    (!String.IsNullOrEmpty(dialogBoxText) && String.Compare(expectedDialogBoxText, dialogBoxText.Trim(), StringComparison.OrdinalIgnoreCase) == 0)) {
        ...
        static bool FindMessageBoxString(IntPtr hwnd, IntPtr unmanagedMemoryLocation) {
