    ...
    public class TestUtils {
        ...
        public static string GetEmbeddedStringResource(Assembly assembly, string resourceName) {
            ...
            if (stream != null) {
                ...
                var fileContentsAsBytes = new byte[stream.Length];
        ...
        /// <returns></returns>
        static string GetNewFileOrDirectoryNameWithoutCreatingAnything(string directory, string baseFileName, string extension) {
        ...
        public void SaveDocument(string documentMoniker) {
            ...
            var runningDocumentTableService = (IVsRunningDocumentTable)VsIdeTestHostContext.ServiceProvider.GetService(typeof(IVsRunningDocumentTable));
            uint docCookie;
            IntPtr docData;
            IVsHierarchy hierarchy;
            uint itemId;
            runningDocumentTableService.FindAndLockDocument((uint)_VSRDTFLAGS.RDT_NoLock, documentMoniker, out hierarchy, out itemId, out docData, out docCookie);
        ...
        public void CloseInEditorWithoutSaving(string fullFileName) {
            ...
            IVsHierarchy hierarchy;
            uint itemId;
            runningDocumentTableService.FindAndLockDocument((uint)_VSRDTFLAGS.RDT_NoLock, fullFileName, out hierarchy, out itemId, out docData, out docCookie);
            ...
            // Close the document
            solutionService.CloseSolutionElement((uint)__VSSLNSAVEOPTIONS.SLNSAVEOPT_NoSave, hierarchy, docCookie);
        }
        #endregion
