...
namespace DXVcsTools.UI.WinForms {
    public partial class BlameViewControl : UserControl {
        readonly Font font = new Font("Courier New", 10);
        ...
        public int CurrentLineIndex {
            get { return infoBox.GetCurrentLineIndex(); }
        }
        ...
        void infoBox_Enter(object sender, EventArgs e) {
            sourceBox.Focus();
        }

        void infoBox_MouseMove(object sender, MouseEventArgs e) {
    ...
    class ExRichTextBox : RichTextBox {
        ...
        public bool ExtendBackColor {
            get { return IsHandleCreated ? (SendMessage(Handle, EM_GETEDITSTYLE, 0, 0) & SES_EXTENDBACKCOLOR) != 0 : extendBackColor; }
            set {
                if (IsHandleCreated)
                    SendMessage(Handle, EM_SETEDITSTYLE, value ? SES_EXTENDBACKCOLOR : 0, SES_EXTENDBACKCOLOR);
                else
        ...
        public Point ScrollPos {
            get {
                ...
                SendMessage(Handle, EM_GETSCROLLPOS, 0, ref scrollPoint);
                int height = GetHeight();
                if (height > 65535)
                    scrollPoint.Y = (int)(scrollPoint.Y * (height / 65535.0));
                return scrollPoint;
            }
            set {
                Point original = value;
                SendMessage(Handle, EM_SETSCROLLPOS, 0, ref original);
            }
        }
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            SendMessage(Handle, EM_SETEDITSTYLE, extendBackColor ? SES_EXTENDBACKCOLOR : 0, SES_EXTENDBACKCOLOR);
        }
